  ...
  return (
    <div className="flex flex-col gap-7">
      <section className="flex flex-col gap-4">
        <h4 className="eyebrow text-ink-accent">Step 1 &mdash; scan this code</h4>
        ...
        <code className="border border-line-subtle bg-surface-inset px-3 py-2 text-center font-mono text-sm break-all text-ink-primary">
          {enrolment.secret}
        </code>
      </section>

      <section className="flex flex-col gap-3">
        <h4 className="eyebrow text-ink-accent">Step 2 &mdash; save your backup codes</h4>
        ...
        <ul className="grid grid-cols-2 gap-2 border border-line-subtle bg-surface-inset p-3">
      ...
      <section className="flex flex-col gap-4">
        <h4 className="eyebrow text-ink-accent">Step 3 &mdash; confirm</h4>
