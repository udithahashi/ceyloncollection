 ...
 */
export async function generateMetadata({ params }: PageProps<'/admin/taxonomy/[key]'>) {
...
export default async function TaxonomyDetailPage({ params }: PageProps<'/admin/taxonomy/[key]'>) {
  const { key } = await params;
  const definition = taxonomyFromSlug(key);
