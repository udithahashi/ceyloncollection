 ...
 */
export default async function DemandBoardPage({ searchParams }: PageProps<'/analytics/demand'>) {
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link href="/analytics" className={buttonVariants({ variant: 'secondary', size: 'sm' })}>
      ...
      <Card>
        <CardContent>
          <RangePicker action="/analytics/demand" range={range} today={todayInBusinessTime()} />
        </CardContent>
      </Card>
