...
export async function generateMetadata({ params }: PageProps<'/leads/[reference]/edit'>) {
 ...
 * after saving.
 */
export default async function EditLeadPage({ params }: PageProps<'/leads/[reference]/edit'>) {
  const { reference } = await params;
